...
mpirun -n $n_gpu --allow-run-as-root python ./pytorch/gpt_sample.py --ckpt_path $ckpt_path --fp16 --head_num $head_num --layer_num $layer_num --vocab_size $vocab_size --output_len $s2 --max_seq_len $max_seq_len --top_k 0 --top_p 0.9 --sample_input_file ./sample_input.txt --time
